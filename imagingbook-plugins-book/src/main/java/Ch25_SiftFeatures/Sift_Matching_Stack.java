 ...
 * @version 2016/01/05
 */
public class Sift_Matching_Stack implements PlugInFilter {
	...
	private static Color SeparatorColor = 	Color.black;
	...
	public void run(ImageProcessor ip) {
		...
		SiftMatcher sm = new SiftMatcher();
