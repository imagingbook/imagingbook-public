...
public class PackagePluginsTest {
    ...
    private static Class<?>[] PLUGINS = {
            Custom_Generic_Filter_Scalar.class,
            Custom_Generic_Filter_Vector.class,
            Filter_Demo_A.class,
            Filter_Demo_B.class,
            Gaussian_Filter.class,
            Gaussian_Filter_Separable.class,
            Linear_Filter_3x3.class,
            Linear_Filter_3x3_Separable.class
    };
