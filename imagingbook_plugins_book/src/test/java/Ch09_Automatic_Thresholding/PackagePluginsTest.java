...
public class PackagePluginsTest {
    ...
    private static Class<?>[] PLUGINS = {
            Adaptive_All.class,
            Adaptive_Bernsen.class,
            Adaptive_Niblack.class,
            Adaptive_Sauvola.class,
            Global_All.class,
            Global_Isodata.class,
            Global_MaxEntropy.class,
            Global_Mean.class,
            Global_Median.class,
            Global_MinError.class,
            Global_MinMax.class,
            Global_Otsu.class,
            Global_Quantile.class
    };
