...
public class PackagePluginsTest {
    ...
    private static Class<?>[] PLUGINS = {
            Bilateral_Filter.class,
            Kuwahara_Filter.class,
            Nagao_Matsuyama_Filter.class,
            Perona_Malik_Filter.class,
            Perona_Malik_Minimal.class,
            Tschumperle_Deriche_Filter.class
    };
