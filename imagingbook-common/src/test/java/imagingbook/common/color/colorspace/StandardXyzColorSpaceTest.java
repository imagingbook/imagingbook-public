 ...
 *
 */
public class StandardXyzColorSpaceTest {
	
	static float TOL = 1e-3f;	// standard color spaces are not very accurate!
	...
	private static void doCheck(ColorSpace cs, int[] srgb) {
		{
			...
			float[] xyz50 = cs.fromRGB(srgbA);
			float[] srgbB = cs.toRGB(xyz50);
