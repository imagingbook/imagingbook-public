...
//		System.out.println(IjUtils.save(bp, tmpdir + "binary-test-dilation1.png"));
		...
		ByteProcessor bp2 = (ByteProcessor) BinaryTestImage.BinaryTestDilation1.getImage().getProcessor();
...
//		System.out.println(IjUtils.save(bp, tmpdir + "BinaryTestDilation2.png"));
		...
		ByteProcessor bp2 = (ByteProcessor) BinaryTestImage.BinaryTestDilation2.getImage().getProcessor();
		assertTrue(ImageTestUtils.match(bp2, bp)); 
	}
...
//		System.out.println(IjUtils.save(bp, tmpdir + "CatDilation3.png"));
		...
		ByteProcessor bp2 = (ByteProcessor) BinaryTestImage.CatDilation3.getImage().getProcessor();
		assertTrue(ImageTestUtils.match(bp2, bp)); 
	}
