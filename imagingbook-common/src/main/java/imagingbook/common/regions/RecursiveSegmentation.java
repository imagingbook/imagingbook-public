...
/**
 * <p>
 * Binary region segmentation based on a recursive (depth-first) flood filling algorithm. See Sec. 8.1.1 (Alg. 8.2) of
 * [1] for additional details. Note that this implementation may easily run out of stack space and should be used for
