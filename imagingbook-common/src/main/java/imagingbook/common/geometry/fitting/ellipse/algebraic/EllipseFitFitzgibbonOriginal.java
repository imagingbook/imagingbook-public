 ...
 * as described in [2] (WITHOUT the additional numerical
 * improvements). Based on generalized symmetric eigenproblem solution.
 ...
 * cannot be applied. Thus at least 6 distinct input points are required (i.e., no duplicate points are
 * allowed).
 * </p>
 * 
 * <p>
 ...
 * <br>
 * [3] W. Burger, M.J. Burge,Digital Image Processing &ndash; An Algorithmicthmic Introduction</em>, 
