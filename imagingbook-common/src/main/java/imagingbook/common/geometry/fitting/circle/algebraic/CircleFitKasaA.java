...
public class CircleFitKasaA extends CircleFitAlgebraic {
	...
	public static void main(String[] args) {
		CircleFitAlgebraic fit = new CircleFitKasaA(PntUtils.fromDoubleArray(ProblemPointSet1));
		System.out.println("q = " + Arrays.toString(fit.getParameters()));
		System.out.println("gc = " + fit.getGeometricCircle());
	}
