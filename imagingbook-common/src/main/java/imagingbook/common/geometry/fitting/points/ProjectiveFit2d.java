...
/**
 * <p>
 * This class implements 2D point fitting under projective (4-point) transformations (exact and least-squares). See Sec.
 * 21.1.4 of [1] for details.
 * </p>
 * <p>
...
public class ProjectiveFit2d implements LinearFit2d {
	...
	/**
	 * Constructor. Fits two sequences of 2D points using a projective transformation model. At least 4 point pairs are
	 * required. For 4 point pairs, the solution is an exact fit, otherwise a least-squares fit is found.
	 *
