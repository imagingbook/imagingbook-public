...
public interface BitVector {
	...
	/**
	 * Returns the contents of this bit vector as a {@code byte} array. Bit-value 0 maps to byte value 0, value 1 maps
	 * to 1.
	 *
	...
	/**
	 * Returns the contents of this bit vector as a {@code boolean} array. Bit-value 0 maps to false, value 1 maps to
	 * true.
	 *
	...
	/**
	 * Creates and returns a new bitvector of type {@link BitVector64} from the specified {@code byte} array. Each byte
	 * element b is interpreted as 0/false if b = 0 and 1/true otherwise.
	 *
	...
	/**
	 * Creates and returns a new bitvector of type {@link BitVector64} from the specified {@code boolean} array, setting
	 * elements to 0/false or 1/true.
	 *
	...
	/**
	 * Creates and returns a new bitvector of type {@link BitVector64} with the specified length. Elements are
