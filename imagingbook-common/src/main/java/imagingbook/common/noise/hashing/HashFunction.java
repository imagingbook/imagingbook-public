 ...
 * </pre>
 * <p>
 * Omit seed in the constructor call or use seed = 0 to get a random seed hash function of the
 * specified type.
 * </p>
 * 
 * @author WB
...
public interface HashFunction {
	...
	/**
	 * 1D hash function: maps a single {@code int} key to a {@code double} hash
	 * value in [0,1].
	 * 
	 * @param u the key
	...
	/**
	 * 2D hash function: maps a pair of {@code int} keys to a pair of {@code double}
	 * hash values in [0,1].
	 * 
	 * @param u the 1st key
	 * @param v the 2nd key
	...
	/**
	 * 3D hash function: maps a triplet of {@code int} keys to a triplet of
	 * {@code double} hash values in [0,1].
	 * 
	 * @param u the 1st key
	 * @param v the 2nd key
	 * @param w the 3rd key
	...
	/**
	 * N-dimensional hash function: maps a N-vector of {@code int} keys to N-vector
	 * of {@code double} hash values in [0,1].
	 * 
