...
public abstract class CustomColorSpace_old extends ColorSpace {
	
	protected CustomColorSpace_old(int type, int numcomponents) {
...
//	}
	 ...
	 */
	public abstract float[] fromCIEXYZ65(float[] xyz65);
...
//	}
	 ...
	 */
	public abstract float[] toCIEXYZ65(float[] value);
