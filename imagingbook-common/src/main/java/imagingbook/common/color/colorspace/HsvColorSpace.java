...
/**
 * <p>
 * Implementation of HSV (hue/saturation/value) color space. See Sec. 13.2.3 of [1] for additional details. All
 * component values are assumed to be in [0,1]. Note that sRGB values passed to method {@link #fromRGB(float[])}
