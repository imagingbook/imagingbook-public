...
public class XYZ65ColorSpace_old extends ColorSpace {
	...
	private static final XYZ65ColorSpace_old instance = new XYZ65ColorSpace_old();
	
	public static XYZ65ColorSpace_old getInstance() {
		return instance;
	}

	private XYZ65ColorSpace_old() {
		super(TYPE_XYZ, 3);
	}
