 ...
 * is done by method {@link #applyTo(float[])}. The underlying linear transformation is specified by a 3x3 matrix, which
 * may be retrieved by {@link #getAdaptationMatrix()}). See Sec. 14.6 of [1] for additional details and examples.
 * </p>
 * <p>
...
//		 {-0.0085286645751770,  0.0400428216540850, 0.9684866957875500}}
	...
	/**
	 * Returns a {@link BradfordAdaptation} instance for the specified white point coordinates.
	 *
	...
	/**
	 * Returns a {@link BradfordAdaptation} instance for the specified illuminants (white points).
	 *
	...
	// 	try (var prec = PrintPrecision.set(9)) {
