...
/**
 * <p>
 * Simple global thresholder which sets the threshold centered between the image's minimum and maximum pixel value. See
 * Sec. 9.1.2 of [1] for additional details (Eq. 9.12).
 * </p>
 * <p>
