 ...
 * quantile (b) to be specified at instantiation. Method {@link #getThreshold(int[])} returns a threshold that will put
 * AT LEAST the b-fraction of pixels (but not all pixels) in the background.
 * </p>
 * <p>
