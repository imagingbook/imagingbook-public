...
/**
 * <p>
 * This is an implementation of the global "minimum error" thresholder proposed
 * by Kittler and Illingworth in [1]. See Sec. 9.1.6 (Alg. 9.6) of [2] for a
 * detailed description.
 * </p>
 * <p>
 * [1] J. Illingworth and J. Kittler. "Minimum error thresholding". Pattern
 * Recognition 19(1), 41–47 (1986). <br>
