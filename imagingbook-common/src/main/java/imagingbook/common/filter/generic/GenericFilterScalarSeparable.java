 ...
 * {@link GenericFilterScalar} but requires two methods to be implemented by concrete sub-classes:
 * {@code doPixelX(PixelSlice, int, int)} and {@code doPixelY(PixelSlice, int, int)} for the x- and y-pass,
